...
plt.scatter(R[6], P[6]*1e-3, s=120, facecolors='none', edgecolors='b', label=r"max $P_{0\degree}=43.6(1)$W")
plt.scatter(R_belast[6], P_belast[6]*1e-3, s=120, facecolors='none', edgecolors='r', label=r"max $P_{60\degree}=21.33(8)$W")
